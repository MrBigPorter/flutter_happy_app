...
class OrderDetailContent extends StatefulWidget {
  ...
  final ValueNotifier<bool> disableScrollNotifier;

  const OrderDetailContent({
    super.key,
    required this.orderId,
    required this.imageList,
    required this.disableScrollNotifier,
  });
      ...
      body: Stack(
        children: [
          ValueListenableBuilder(
              valueListenable: widget.disableScrollNotifier,
              builder: (context, disableScroll, child) {
                print('OrderDetailContent rebuild with disableScroll=${disableScroll}');
                return   IgnorePointer(
                  ignoring: disableScroll,
