      ...
      ($checkedConvert) {
        final val = GroupForTreasureItem(
          ...
          treasure: $checkedConvert(
              ...
              (v) => v == null
                  ? null
                  : GroupTreasure.fromJson(v as Map<String, dynamic>)),
        );
        return val;
      },
    );
      ...
      ($checkedConvert) {
        final val = GroupMemberItem(
          ...
          user: $checkedConvert(
              ...
              (v) => v == null
                  ? null
                  : GroupUser.fromJson(v as Map<String, dynamic>)),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = GroupTreasure(
          ...
          unitAmount: $checkedConvert('unitAmount',
...
HotGroupItem _$HotGroupItemFromJson(Map<String, dynamic> json) => HotGroupItem(
      ...
      recentJoinAvatars: (json['recentJoinAvatars'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          [],
