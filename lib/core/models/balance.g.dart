      ...
      ($checkedConvert) {
        final val = Balance(
          realBalance: $checkedConvert(
              'realBalance', (v) => JsonNumConverter.toDouble(v)),
          coinBalance: $checkedConvert(
              'coinBalance', (v) => JsonNumConverter.toDouble(v)),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = RechargeResponse(
          ...
          rechargeStatus:
              $checkedConvert('rechargeStatus', (v) => (v as num).toInt()),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WalletTransactionsDto(
          ...
          balanceType:
              $checkedConvert('balanceType', (v) => (v as num?)?.toInt()),
          transactionType:
              $checkedConvert('transactionType', (v) => (v as num?)?.toInt()),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WalletWithdrawResponse(
          ...
          withdrawStatus:
              $checkedConvert('withdrawStatus', (v) => (v as num).toInt()),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WalletWithdrawHistoryItem(
          ...
          accountName: $checkedConvert('accountName', (v) => v as String),
          withdrawAccount:
              $checkedConvert('withdrawAccount', (v) => v as String),
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WalletRechargeHistoryItem(
          ...
          channelCode: $checkedConvert('channelCode', (v) => v as String?),
          paymentChannel:
              $checkedConvert('paymentChannel', (v) => v as String?),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = PaymentChannelConfigItem(
          ...
          minAmount:
              $checkedConvert('minAmount', (v) => JsonNumConverter.toDouble(v)),
          maxAmount:
              $checkedConvert('maxAmount', (v) => JsonNumConverter.toDouble(v)),
          feeRate:
              $checkedConvert('feeRate', (v) => JsonNumConverter.toDouble(v)),
          feeFixed:
              $checkedConvert('feeFixed', (v) => JsonNumConverter.toDouble(v)),
          fixedAmounts: $checkedConvert('fixedAmounts',
