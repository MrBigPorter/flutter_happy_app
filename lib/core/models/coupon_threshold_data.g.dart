...
CouponThresholdData _$CouponThresholdDataFromJson(Map<String, dynamic> json) =>
    $checkedCreate('CouponThresholdData', json, ($checkedConvert) {
      final val = CouponThresholdData(
        ...
        treasureId: $checkedConvert('treasureId', (v) => (v as num?)?.toInt()),
        useAtEnd: $checkedConvert('useAtEnd', (v) => (v as num?)?.toInt()),
        useAtStart: $checkedConvert('useAtStart', (v) => (v as num?)?.toInt()),
...
) => $checkedCreate('CouponThresholdResponse', json, ($checkedConvert) {
