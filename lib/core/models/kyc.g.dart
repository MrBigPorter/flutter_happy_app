...
KycSession _$KycSessionFromJson(Map<String, dynamic> json) => $checkedCreate(
      'KycSession',
      json,
      ($checkedConvert) {
...
KycMe _$KycMeFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = KycMe(
          kycStatus:
              $checkedConvert('kycStatus', (v) => (v as num?)?.toInt() ?? 0),
...
KycIdTypes _$KycIdTypesFromJson(Map<String, dynamic> json) => $checkedCreate(
      'KycIdTypes',
      json,
      ($checkedConvert) {
        final val = KycIdTypes(
          ...
          requiresFront: $checkedConvert(
              'requiresFront', (v) => (v as num?)?.toInt() ?? 0),
          requiresBack:
              $checkedConvert('requiresBack', (v) => (v as num?)?.toInt() ?? 0),
          requiresOcr:
              $checkedConvert('requiresOcr', (v) => (v as num?)?.toInt() ?? 0),
        );
        return val;
      },
    );
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = KycOcrResult(
          ...
          typeText:
              $checkedConvert('typeText', (v) => v as String? ?? 'UNKNOWN'),
          ...
          expiryDate:
              $checkedConvert('expiryDate', (v) => (v as num?)?.toInt()),
          isSuspicious: $checkedConvert(
              'isSuspicious', (v) => v == null ? false : _boolFromJson(v)),
          fraudScore: $checkedConvert(
              'fraudScore', (v) => v == null ? 0.0 : _doubleFromJson(v)),
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = SubmitKycDto(
          ...
          sourceOfIncome:
              $checkedConvert('sourceOfIncome', (v) => v as String?),
          ...
          verifyResult: $checkedConvert(
              'verifyResult', (v) => v as Map<String, dynamic>?),
        );
        return val;
      },
    );
...
Map<String, dynamic> _$SubmitKycDtoToJson(SubmitKycDto instance) {
  ...
  val['provinceId'] = instance.provinceId;
  ...
  writeNotNull('sourceOfIncome', instance.sourceOfIncome);
  writeNotNull('natureOfWork', instance.natureOfWork);
  writeNotNull('employerName', instance.employerName);
  writeNotNull('verifyResult', instance.verifyResult);
  return val;
}
